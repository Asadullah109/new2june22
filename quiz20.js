...
const questions = [
    ...
    },
    {
        type: 'list',
        name: 'q24',
        message: 'Which of the following is the correct way to define a function that returns a Promise in TypeScript?',
        choices: [
            'function fetchData(): Promise<string> { return Promise.resolve("data"); }',
            'function fetchData(): Promise<string> { return "data"; }',
            'function fetchData(): string { return Promise.resolve("data"); }',
            'function fetchData(): Promise { return "data"; }'
        ],
        correctAnswer: 'function fetchData(): Promise<string> { return Promise.resolve("data"); }'
    },
    {
        type: 'list',
        name: 'q25',
        message: 'What is the purpose of the "keyof" operator in TypeScript?',
        choices: [
            'To get the keys of an object type as a union of string literals',
            'To access the value of a specific key in an object',
            'To define a key-value pair in an interface',
            'To declare a property as optional'
        ],
        correctAnswer: 'To get the keys of an object type as a union of string literals'
    }
];
