...
// EXERCISE_12
let members2: string[] = ['azam', 'saqlain', 'mehmood', 'saba', 'sana'];
let message2: string = 'kal birthday hai kis ki:';
for (let i = 0; i < members2.length; i++) {
  console.log(message2 + members2[i]);
}

// EXERCISE_13
let vehicles: string[] = ['bike', 'car'];
...
// EXERCISE_15
let guest_list2: string[] = ['ali', 'farhan', 'raza', 'ayesha'];
...
// EXERCISE_16
let guest_list3: string[] = ['ali', 'farhan', 'raza', 'ayesha'];
...
// EXERCISE_17
let guest_list4: string[] = ['ali', 'farhan', 'raza', 'ayesha'];
let not_present3: string = 'farhan';
let new_guest3: string = 'Babar Azam';
...
// EXERCISE_19
let guest_list5: string[] = ['ali', 'farhan', 'raza', 'ayesha'];
let not_present4: string = 'farhan';
let new_guest4: string = 'Babar Azam';
