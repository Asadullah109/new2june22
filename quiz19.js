...
}
{
    ...
    'q2',
        message;
    'Which of the following is a correct way to define a tuple in TypeScript?',
        choices;
    [
        'let tuple: [string, number] = ["hello", 42];',
        'let tuple: (string, number) = ["hello", 42];',
...
}
{
    ...
    'q5',
        message;
    'Which of the following TypeScript features allows you to define a variable that can hold multiple types?',
        choices;
    [
        'Interfaces',
        'Union Types',
...
}
{
    ...
    'q7',
        message;
    'Which of the following TypeScript types can be used to create a variable that should never be assigned a value?',
        choices;
    [
        'null',
        'undefined',
...
}
{
    ...
    'q9',
        message;
    'Which of the following is NOT a valid way to declare an array in TypeScript?',
        choices;
    [
...
}
{
    ...
    'q15',
        message;
    'What is the main purpose of TypeScript "generics"?',
        choices;
    [
...
}
{
    ...
    'q17',
        message;
    'Which of the following is a feature of TypeScript "Enums"?',
        choices;
    [
...
}
{
    ...
    'q19',
        message;
    'Which of the following TypeScript features is used to define a new type that is the combination of two or more existing types?',
        choices;
    [
        'Union Types',
        'Intersection Types',
...
}
{
    ...
    'q21',
        message;
    'Which of the following is a correct way to define an optional property in a TypeScript interface?',
        choices;
    [
